...
// //============================SLIDER====================================
// Route::middleware('auth:api')->get('slider', 'api\ProductController@slider');
// Route::middleware('auth:api')->post('update_slider', 'api\ProductController@update_slider');

// Route::middleware('auth:api')->get('galeria', 'api\ProductController@galeria');
// Route::middleware('auth:api')->post('update_galeria', 'api\ProductController@update_galeria');
