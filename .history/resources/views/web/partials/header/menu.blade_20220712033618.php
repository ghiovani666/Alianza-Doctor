                                    ...
                                    <nav class="main-menu menu-mobile" id="menu">
                                        <ul class="menu">
                                            ...
                                            <li class="mega-menu-item active_menu_4">
                                                ...
                                                <ul class="mega-submenu">
                                                    <li><a href="/web_publicacion_internacional">Curso básico online</a></li>
                                                    <li><a href="/web_saludnatural">Charlas informativas</a></li>
                                                    <li><a href="/web_informativos">Cursos y talleres</a></li>
                                                    <li><a href="/web_revistas">Talleres Escolares</a></li>
                                                </ul>

                                            </li>
                                            <li class="mega-menu-item active_menu_4">
                                                <a href="https://alianzadrrath.org/blog/" class="mega-menu-link">Blog</a>
                                            </li>
