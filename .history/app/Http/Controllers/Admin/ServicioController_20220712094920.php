...
{        
 ...
 {        
    ...
    {       
        $data =  DB::table('web_servicio_descripcion')->where("id", $request->txt_id_descripcion)->update(['descripcion' => $request->txt_descripcion_info]); 
        return $data;
    }
    ...
    public function listarDataTableInfo(Request $request) {
      ...
      $rowData_ =  DB::table('web_servicio_descripcion')->where("id_descripcion", $request->txt_id_descripcion)->update(['descripcion' => $request->txt_descripcion_info]); 
